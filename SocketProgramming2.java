...
public class SocketProgramming2 {
	...
	public void echo() {
		try {
			File responseFile = new File("C:\\Users\\user\\Desktop\\Åñãáóßá Äßêôõá_2\\ÄÅÕÔÅÑÇ_ÓÕÍÏÄÏÓ\\ECHO\\ResponseTime_no.txt");
			FileOutputStream out = new FileOutputStream(responseFile);
			Writer w = new OutputStreamWriter(out);
			
			File times = new File("C:\\Users\\user\\Desktop\\Åñãáóßá Äßêôõá_2\\ÄÅÕÔÅÑÇ_ÓÕÍÏÄÏÓ\\ECHO\\Times_no.txt");
	...
	public void throughput(List<Integer> l, int startTime, int endTime) {
		try {
			File throughput = new File("C:\\Users\\user\\Desktop\\Åñãáóßá Äßêôõá_2\\ÄÅÕÔÅÑÇ_ÓÕÍÏÄÏÓ\\ECHO\\Throughput_no.txt");
	...
	public void image() {
		...
		try {
			...
			ImageIO.write(bufferedImage, "jpg", new File("C:\\Users\\user\\Desktop\\Åñãáóßá Äßêôõá_2\\ÄÅÕÔÅÑÇ_ÓÕÍÏÄÏÓ\\IMAGE\\image_FIX.jpg"));
	...
	public void audio() {
		...
		try {			
			File samples = new File("C:\\Users\\user\\Desktop\\Åñãáóßá Äßêôõá_2\\ÄÅÕÔÅÑÇ_ÓÕÍÏÄÏÓ\\SOUND_AQDPCM\\SAMPLES.txt");
			FileOutputStream out = new FileOutputStream(samples);
			Writer w = new OutputStreamWriter(out);
			
			File difference = new File("C:\\Users\\user\\Desktop\\Åñãáóßá Äßêôõá_2\\ÄÅÕÔÅÑÇ_ÓÕÍÏÄÏÓ\\SOUND_AQDPCM\\DIFFERENCES.txt");
			...
			File cutaudioFile = new File ("C:\\Users\\user\\Desktop\\Åñãáóßá Äßêôõá_2\\ÄÅÕÔÅÑÇ_ÓÕÍÏÄÏÓ\\SOUND_AQDPCM\\FREQ.wav");
	...
	public void audioAQ() {
		...
		try {
			File samples = new File("C:\\Users\\user\\Desktop\\Åñãáóßá Äßêôõá_2\\ÄÅÕÔÅÑÇ_ÓÕÍÏÄÏÓ\\SOUND_AQDPCM\\1.txt");
			FileOutputStream out = new FileOutputStream(samples);
			Writer w = new OutputStreamWriter(out);
			
			File difference = new File("C:\\Users\\user\\Desktop\\Åñãáóßá Äßêôõá_2\\ÄÅÕÔÅÑÇ_ÓÕÍÏÄÏÓ\\SOUND_AQDPCM\\2.txt");
			FileOutputStream out2 = new FileOutputStream(difference);
			Writer w2 = new OutputStreamWriter(out2);
			
			File time = new File("C:\\Users\\user\\Desktop\\Åñãáóßá Äßêôõá_2\\ÄÅÕÔÅÑÇ_ÓÕÍÏÄÏÓ\\SOUND_AQDPCM\\3.txt");
			...
			lineOut.write(audioBufferOut, 0, audioBufferOut.length);
			lineOut.stop();
			File cutaudioFile = new File ("C:\\Users\\user\\Desktop\\Åñãáóßá Äßêôõá_2\\ÄÅÕÔÅÑÇ_ÓÕÍÏÄÏÓ\\SOUND_AQDPCM\\4.wav");
			InputStream in=new ByteArrayInputStream(audioBufferOut);
            AudioInputStream ais = new AudioInputStream(in, linearPCM, audioBufferOut.length);
            AudioSystem.write(ais, Type.WAVE, cutaudioFile);
			System.out.println("Audio ended.");
	...
	public void ithakiCopter() {		
		try {
			File lmotor = new File("C:\\Users\\user\\Desktop\\Åñãáóßá Äßêôõá_2\\ÄÅÕÔÅÑÇ_ÓÕÍÏÄÏÓ\\COPTER\\LMOTOR2.txt");
			FileOutputStream out = new FileOutputStream(lmotor);
			Writer w = new OutputStreamWriter(out);
			File rmotor = new File("C:\\Users\\user\\Desktop\\Åñãáóßá Äßêôõá_2\\ÄÅÕÔÅÑÇ_ÓÕÍÏÄÏÓ\\COPTER\\RMOTOR2.txt");
			FileOutputStream out2 = new FileOutputStream(rmotor);
			Writer w2 = new OutputStreamWriter(out2);
			File altitude = new File("C:\\Users\\user\\Desktop\\Åñãáóßá Äßêôõá_2\\ÄÅÕÔÅÑÇ_ÓÕÍÏÄÏÓ\\COPTER\\ALTITUDE2.txt");
			FileOutputStream out3 = new FileOutputStream(altitude);
			Writer w3 = new OutputStreamWriter(out3);
			File timeCopter = new File("C:\\Users\\user\\Desktop\\Åñãáóßá Äßêôõá_2\\ÄÅÕÔÅÑÇ_ÓÕÍÏÄÏÓ\\COPTER\\Time_copter2.txt");
	...
	public void obd() {
		...
		try {
			...
			File obd = new File("C:\\Users\\user\\Desktop\\Åñãáóßá Äßêôõá_2\\ÄÅÕÔÅÑÇ_ÓÕÍÏÄÏÓ\\obd\\rpm.txt");
